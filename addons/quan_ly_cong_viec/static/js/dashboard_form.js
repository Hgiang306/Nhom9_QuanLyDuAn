odoo.define('dashboard.form_view', function (require) {
    "use strict";
    ...
    var DashboardFormController = FormController.extend({
        start: function () {
            var self = this;
            return this._super.apply(this, arguments).then(function () {
                if (self.modelName === 'dashboard') {
        ...
        loadCharts: function () {
            ...
            this.loadStatusPieChart();
            this.loadRecentProjectsTable();
        },
                ...
                if (ctx && typeof Chart !== 'undefined') {
                    ...
                    new Chart(chartContext, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                data: [
                                    data.du_an_dang_thuc_hien || 0,
                                    data.du_an_hoan_thanh || 0,
                                    data.du_an_chua_bat_dau || 0
                                ],
                                backgroundColor: [
                                    '#2196f3',
                                    '#4caf50',
        ...
        loadRecentProjectsTable: function () {
            rpc.query({
                model: 'du_an',
                method: 'search_read',
